        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DestinyAccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CategoryUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CategoryUserName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ...
                    IsReversal = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Categories_CategoryUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CategoryUserId",
                table: "Transactions",
                column: "CategoryUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_DestinyAccountId",
                table: "Transactions",
