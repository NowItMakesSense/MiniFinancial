...
namespace MiniFinancial.Presentation.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        {
            var query = new GetAccountByIdCommand(id);
        ...
        [HttpDelete("{id:guid}")]
        [Authorize]
        public async Task<IActionResult> Delete(Guid id, [FromBody] RemoveAccountCommand command, CancellationToken cancellationToken)
        {
            if (id != command.Id) return BadRequest("Id da rota diferente do corpo.");
