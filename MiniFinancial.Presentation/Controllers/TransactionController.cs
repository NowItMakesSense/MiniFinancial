...
namespace MiniFinancial.Presentation.Controllers
{
    ...
    public class TransactionController : ControllerBase
    {
        ...
        {
            var query = new GetTransactionByIdCommand(id);
        ...
        [HttpPost]
        [Authorize]
        public async Task<IActionResult> Register([FromBody] RegisterTransactionCommand command, CancellationToken cancellationToken)
        {
